    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.spacer}>
        ...
        <Text style={styles.middlePar}>
          ...
          software ("Software") directly from Phlokk LLC or indirectly through a
          Phlokk LLC authorized reseller or distributor (a "Reseller"). Please
          read this EULA agreement carefully before completing the installation
          process and using the Phlokk software. It provides a license to use
          the Phlokk software and contains warranty information and liability
          disclaimers.
        </Text>
        ...
        <Text style={styles.middlePar}>
          ...
          load the Phlokk software (for example a PC, laptop, mobile or tablet)
          under your control. You are responsible for ensuring your device meets
          the minimum requirements of the Phlokk software. You are not permitted
          to:
        </Text>
        <Text style={styles.middlePar}>
          * Edit, alter, modify, adapt, translate or otherwise change the whole
          ...
          {"\n"}* use the Software for any purpose that Phlokk LLC considers is
        ...
        <Text style={styles.middlePar}>
          ...
          any time upon written notice to Phlokk LLC. It will also terminate
          ...
          agreement will immediately terminate and you agree to stop all access
          and use of the Software. The provisions that by their nature continue
