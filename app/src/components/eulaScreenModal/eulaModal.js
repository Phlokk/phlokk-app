      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.spacer}>
          ...
          <Text style={styles.middlePar}>
            ...
            between you and Phlokk LLC.
          </Text>

          <Text style={styles.middlePar}>
            This EULA agreement governs your acquisition and use of our Phlokk
            software ("Software") directly from Phlokk LLC or indirectly through
            a Phlokk LLC authorized reseller or distributor (a "Reseller").
            Please read this EULA agreement carefully before completing the
            installation process and using the Phlokk software. It provides a
            license to use the Phlokk software and contains warranty information
          ...
          <Text style={styles.middlePar}>
            ...
            the Software, and you must not accept this EULA agreement. This EULA
            agreement shall apply only to the Software supplied by Phlokk LLC
            herewith regardless of whether other software is referred to or
            described herein. The terms also apply to any Phlokk LLC updates,
          ...
          <Text style={styles.middlePar}>
            Phlokk LLC hereby grants you a personal, non-transferable,
            non-exclusive licence to use the Phlokk software on your devices in
            accordance with the terms of this EULA agreement. You are permitted
            to load the Phlokk software (for example a PC, laptop, mobile or
            tablet) under your control. You are responsible for ensuring your
            device meets the minimum requirements of the Phlokk software. You
          ...
          <Text style={styles.middlePar}>
            * Edit, alter, modify, adapt, translate or otherwise change the
            ...
            {"\n"}* use the Software for any purpose that Phlokk LLC considers
          ...
          <Text style={styles.middlePar}>
            ...
            at any time upon written notice to Phlokk LLC. It will also
            ...
            governed by and construed in accordance with the laws of us.
          </Text>
